    ...
    return (
      <div className="p-4 sm:p-6 space-y-5 max-w-xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-[#E2E6F0] shadow-[0_2px_8px_rgba(8,26,58,0.05)] divide-y divide-[#F0F2F7]">
          ...
          <div className="px-5 py-3.5 flex justify-between items-center">
            <span className="text-sm text-[#8896A7]">الاستشارة</span>
            <span className="text-sm font-medium text-[#0A1628]">{inv.consultation?.subject || inv.consultation_id}</span>
          </div>
          <div className="px-5 py-3.5 flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button onClick={() => router.push('/finance/consulting-invoices')}
          ...
          <button onClick={() => { setInvoiceResult(null); setForm({ consultation_id: '', amount: '' }); }}
        ...
        <div className="relative flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-xl font-bold" style={{ color: '#ffffff' }}>فاتورة استشارة جديدة</h1>
            </div>
          </div>
          <Link href="/finance/consulting-invoices"
