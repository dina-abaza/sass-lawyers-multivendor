...
export const customersApi = {
  ...
  update: (api, id, data) => api.post(`/customers/${id}`, data),
...
export const consultationsApi = {
  ...
  respond: (api, id, data) => api.put(`/consultations/${id}/response`, data),
...
export const wakalasApi = {
  ...
  update: (api, id, data) => api.post(`/wakalas/${id}`, data),
