...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen bg-gray-900 flex flex-col overflow-y-auto">
      <div className="h-16 flex items-center px-6 border-b border-gray-700 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">المشرف العام</p>
          </div>
        </div>
      </div>
          ...
          <div key={gi}>
            ...
            <div className="space-y-0.5">
              {group.items.map((item) => (
                ...
                >
                  <svg
                    className={`w-4 h-4 flex-shrink-0 ${isActive(item.href) ? 'text-white' : 'text-gray-500'}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
